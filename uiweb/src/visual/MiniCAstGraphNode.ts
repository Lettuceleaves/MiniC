...
export const miniCAstGraphNodeMirror = {
  ...
  fields: [],
  methods: [{ name: "MiniCAstGraphNode", signature: "MiniCAstGraphNode(String id, String label, int depth, double x, double y, boolean active, boolean leaf, boolean root)" }],
